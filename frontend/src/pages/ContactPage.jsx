...
export default function ContactPage() {
  ...
  return (
    <main className="contact-page min-vh-50 pb-5">
      <div className="container section-padding pb-3 pb-lg-4">
        <div className="row justify-content-center text-center">
          <div className="col-lg-10 col-xl-8">
            ...
            <p className="text-secondary fs-5 mb-4">{displayAddress(settings)}</p>
            ...
            <p className="text-secondary mb-2">{displayHoursLine(settings)}</p>
            <p className="mb-0">
